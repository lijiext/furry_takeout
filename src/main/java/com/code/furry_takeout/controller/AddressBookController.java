...
public class AddressBookController {
    ...
    public R<AddressBook> save(@RequestBody AddressBook addressBook) {
        addressBook.setUserId(BaseContext.getCurrentEmployeeId());
    ...
    public R<AddressBook> setDefault(@RequestBody AddressBook addressBook) {
        ...
        wrapper.eq(AddressBook::getUserId, BaseContext.getCurrentEmployeeId());
    ...
    public R<AddressBook> getDefault() {
        ...
        queryWrapper.eq(AddressBook::getUserId, BaseContext.getCurrentEmployeeId());
    ...
    public R<String> ModifyAddressBook(@RequestBody AddressBook addressBook) {
        addressBook.setUserId(BaseContext.getCurrentEmployeeId());
        log.info("用户 {} 修改地址 {}", BaseContext.getCurrentEmployeeId(), addressBook);
        addressBookService.updateById(addressBook);
    ...
    public R<String> DeleteAddress(@RequestParam List<Long> ids) {
        log.info("用户 {} 删除地址 {}", BaseContext.getCurrentEmployeeId(), ids);
